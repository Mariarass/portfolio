...
import { FirstGirl } from './FirstGirl';
import { SecondGirl } from './SecondGril';
import { ThirdGirl } from './ThirdGirl';
...
const StartPage = () => {
    const {currentGirl,setCurrentGirl}=useStore()
    ...
    return (
        ...
        <div className={s.startPage}>
            <div className={s.header}>
                <h3>before start choose your character</h3>
            </div>
            ...
            <button className={s.btn}>
                <span className={s.front} onClick={handleChoose}>Choose</span>
            </button>

            <div className={s.containerLeftPanel}>
               <img className={s.img}   onClick={() => handleModelSelect('firstGirl')} src={first_img}/>
                <img className={s.img} onClick={() => handleModelSelect('secondGirl')}  src={second_img}/>
                <img className={s.img} onClick={() => handleModelSelect('thirdGirl')} src={third_img}/>
            </div>
